...
interface IProps<T, V extends OperationVariables> {
  query: QueryResult<T, V> | MutationResult<T>;
  children: (t: T) => JSX.Element;
  notCalledMessage?: JSX.Element;
}

export function WithQuery<T, V extends OperationVariables>({query: {data, loading, error, called}, children, notCalledMessage}: IProps<T, V>): JSX.Element {

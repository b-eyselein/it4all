object CompilerOptions {
  ...
  private val unusedCodeOptions: Seq[String] = Seq(
    "-Ywarn-dead-code",
    //    "-Ywarn-unused",// TODO: clashes with default imports in view files...
    "-Ywarn-value-discard"
  )
  ...
  private val warnOptions: Seq[String] = Seq(
    "-Ywarn-dead-code",         // Warn when dead code is identified.
    "-Ywarn-extra-implicit",    // Warn when more than one implicit parameter section is defined.
    "-Ywarn-numeric-widen",     // Warn when numerics are widened.
    "-Ywarn-unused:-implicits", // TODO: DO NOT! Warn if an implicit parameter is unused.
    //    "-Ywarn-unused:imports", // Warn if an import selector is not referenced. // TODO: clashes with default imports in view files...

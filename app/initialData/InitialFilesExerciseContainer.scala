...
abstract class InitialFilesExerciseContainer(toolId: String, collectionId: Int, exerciseId: Int) extends InitialExerciseContainer(toolId, collectionId, exerciseId) {

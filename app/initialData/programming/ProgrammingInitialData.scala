...
import model.tools.programming.{ProgrammingExerciseContent, ProgrammingTopics}

object ProgrammingInitialData {

  val initialData: InitialData[ProgrammingExerciseContent] = InitialData[ProgrammingExerciseContent](
    topics = ProgrammingTopics.values,

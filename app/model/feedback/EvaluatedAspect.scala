...
object EvaluatedAspects extends PlayEnum[EvaluatedAspect] {
  ...
  case object USED
      extends EvaluatedAspect(
        "Wie oft haben Sie dieses Tool genutzt?",
        positive = "Oft",
        "Manchmal",
        negative = "Selten"
      )
  ...
  case object SENSE
      extends EvaluatedAspect("Finden Sie dieses Tool sinnvoll?", positive = "Sinnvoll", negative = "Sinnlos")
  ...
  case object FAIRNESS_OF_FEEDBACK
      extends EvaluatedAspect(
        "Wie bewerten Sie die Fairness der Evaluation dieses Tools?",
        positive = "Fair",
        negative = "Unfair"
      )

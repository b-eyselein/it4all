...
import model.{Exercise, Difficulties, Difficulty, ExPart, ExerciseReview, ExerciseState, SemanticVersion}
...
trait IdExerciseTableDefs[CompEx <: Exercise, PartType <: ExPart, ReviewType <: ExerciseReview[PartType]]

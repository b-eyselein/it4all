...
/* extends ASolutionDbModels[String, PartType, StringSampleSolution, DbStringSampleSolution, StringUserSolution[PartType], DbStringUserSolution[PartType]] */ {
  ...
  def dbUserSolFromUserSol[PartType <: ExPart](exId: Int, exSemVer: SemanticVersion, collId: Int, username: String, solution: StringUserSolution[PartType]): DbStringUserSolution[PartType] =
  ...
  def userSolFromDbUserSol[PartType <: ExPart](dbSolution: DbStringUserSolution[PartType]): StringUserSolution[PartType] =
    StringUserSolution[PartType](dbSolution.id, dbSolution.part, dbSolution.solution, dbSolution.points, dbSolution.maxPoints)

}

final case class DbStringSampleSolution(id: Int, exId: Int, exSemVer: SemanticVersion, collId: Int, sample: String) extends ADbSampleSol
...
final case class DbStringUserSolution[PartType <: ExPart](id: Int, exId: Int, exSemVer: SemanticVersion, collId: Int, username: String,
                                                          part: PartType, solution: String, points: Points, maxPoints: Points) extends ADbUserSol[PartType]

...
object XmlToolJsonProtocol extends ToolJsonProtocol[XmlSolution, XmlSolution, XmlExerciseContent, XmlExPart] {

  override val partTypeFormat: Format[XmlExPart] = XmlExPart.jsonFormat

  private val xmlSolutionFormat = Json.format[XmlSolution]

  override val solutionFormat: Format[XmlSolution] = xmlSolutionFormat
  ...
  override val exerciseContentFormat: OFormat[XmlExerciseContent] = {
    implicit val ssf: Format[XmlSolution] = solutionFormat

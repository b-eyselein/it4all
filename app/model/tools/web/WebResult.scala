...
final case class ElementResult(task: WebTask, foundElement: Option[WebElement], attributeResults: Seq[AttributeResult], textContentResult: Option[TextContentResult])
  extends WebResult {
...
final case class AttributeResult(attribute: HtmlAttribute, maybeFoundContent: Option[String]) extends
...
final case class JsWebResult(task: JsTask, preResults: Seq[ConditionResult], actionPerformed: Boolean, postResults: Seq[ConditionResult])
  extends WebResult {

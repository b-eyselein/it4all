...
(implicit ec: ExecutionContext)
  ...
  // FIXME: make abstract...
  protected def renderExListRest(b: B): Html = ???

  private def previewExercises(admin: User, read: Seq[CompEx], toolObject: ExToolObject): Html = views.html.admin.preview(admin, read, toolObject)

...
insert into task (`exercise_id`, `id`, `taskDesc`, `tag_name`, `attributes`, `defining_attribute`) values
	...
	"//input", "type=date:required=true:value=2016-01-01", "name=datum"),
	...
	"//select", "required=true", "name=marke"),

...
insert into task (`exercise_id`, `id`, `taskDesc`, `tagName`, `attributes`, `defining_attribute`) values
	(1, 1, "Der Titel der Seite soll 'Kontaktformular Werkstatt' lauten.", "title", "", ""),
	
	(1, 2, "Erstellen Sie ein Formular auf der Seite. Als Aktion soll test und als Methode 'post' angegeben werden.",
	 "form", "action=test:method=post",  ""),
	
	(1, 3, "Erstellen Sie ein Namensfeld* (name) für den kompletten Namen des Kunden.", "input",
	 "type=text:required=true", "name=name"),
	
	(1, 4, "Erstellen Sie ein Feld für die Emailadresse* (email) des Kunden.", "input", 
	 "type=email:required=true", "name=email"),
	
	(1, 5, "Erstellen Sie ein Datumsfeld* (datum), um einen Wunschtermin angeben zu können.
	...
	(1, 7, "Ein weiteres Dropdownmenü (modell), um passende Automodelle auswählen zu können. Geben Sie je Hersteller
	...
	(1, 8, "Erstellen Sie ein Eingabefeld* (jahr) für das Baujahr des Autos (1950 <= year <= 2016). Als Vorgabe soll
	 2000 eingestellt sein.",
	 "input", "type=number:required=true:value=2000", "name=jahr"),
	 
	(1, 9, "Erstellen Sie eine Checkbox* (agb), um die AGBs der Seite zu akzeptieren",
	 "input", "type=checkbox:required=true", "name=agb"),
	 
	(1, 10, "Erstellen Sie eine Möglichkeit, das Formular abzusenden. Geben Sie als Wert 'Absenden' an.",

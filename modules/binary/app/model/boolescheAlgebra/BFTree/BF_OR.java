...
public class BF_OR implements BFKnoten {
  ...
  public String toString() {
    String s;
    if(this.linkerK.getClass() == BF_OR.class || this.linkerK.getClass() == BF_AND.class
        || this.linkerK.getClass() == BF_Variable.class || this.linkerK.getClass() == BF_NOT.class
        || this.linkerK.getClass() == BF_1.class || this.linkerK.getClass() == BF_0.class) {
      s = "" + linkerK.toString() + " OR ";
    } else {
      s = "(" + linkerK.toString() + ") OR ";
    }
    if(this.rechterK.getClass() == BF_OR.class || this.rechterK.getClass() == BF_AND.class
        || this.rechterK.getClass() == BF_Variable.class || this.rechterK.getClass() == BF_NOT.class

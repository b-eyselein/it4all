...
public class NumberBaseTest {
  ...
  public void testGetSystemName() {
    assertThat(NumberBase.BINARY.getSystemName(), equalTo("Binärsystem"));
    assertThat(NumberBase.OCTAL.getSystemName(), equalTo("Oktalsystem"));
    assertThat(NumberBase.DECIMAL.getSystemName(), equalTo("Dezimalsystem"));
    assertThat(NumberBase.HEXADECIMAL.getSystemName(), equalTo("Hexadezimalsystem"));
  }

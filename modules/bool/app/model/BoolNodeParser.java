...
import static model.ScalaNode.constant;
...
public class BoolNodeParser {
  ...
  public static ScalaNode parse(String formulaToParse) throws CorrectionException {
  ...
  private static ScalaNode handleVarOrConst(String formula) throws CorrectionException {

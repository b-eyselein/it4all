...
public interface AbstractParser {
   ...
   * @throws Exception
   */
  public abstract List<TreeNode> read(File file) throws Exception;
   ...
   * @throws Exception
   */
  public abstract void write(String filepath, List<TreeNode> rootList, String templatePath) throws Exception;
}

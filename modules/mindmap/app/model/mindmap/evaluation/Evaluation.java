...
public class Evaluation {
  ...
  // /**
  // * This method uses the MindManager parser to read and create mindmaps. It
  // is
  // * currently the only supported parser. For parameter description
  // * @see {@link #evaluate(String, String, String, String, String, String,
  ...
  //
  // /**
  // * This method performs the evaluation of a mindmap from a user in
  // comparison
  // * to a solution mindmap. In order to do this, several parameters are
  // needed.
  // * At first a specific parser must be chosen (currently only MindManager is
  // supported).
  // * The path to the user generated file (input) is needed as well as the path
  // to
  // * the sample solution. Further paths to the used template and the meta file
  // are needed.
  // * The template defines the look of the altered solution/input files. It is
  // important
  // * that the meta file and properties file follow a specific definition.
  // * This method also creates three new files. Two of them are altered
  // versions
  // * of the input/solution mindmaps and the third is an overview of the
  // evaluation results.
  ...
  // * @param solution the path to the mindmap which represents the perfect
  // solution
  // * @param result the path where the result overview will be generated
  // * @param alteredSolution the path where the altered solution will be
  // generated
  ...
  // * @throws Exception
  // */
  // public static void evaluate(String parserType, String input, String
  // solution,
  ...
  // AbstractEvaluationParser abstractEvaluationParser =
  // ParserFactory.getEvaluationParser(parserType);
  // abstractEvaluationParser.setModus(properties.getModus());
  // LinkedList<TreeNode> inputRoots = abstractEvaluationParser.read(new
  // File(input));
  // LinkedList<TreeNode> solutionRoots = abstractEvaluationParser.read(new
  // File(solution));
  // //this must be called before handleMetaData()... //else there might be
  // redundant 'yes' in the optional column of the meta file.
  ...
  // HashMap<String, LinkedList<Tupel>> mapSolutions =
  // Util.buildTupels(solutionRoots);
  // TupelDifferenceContainer resultDifferences =
  // Util.getDifferenceTupel(mapSolutions, mapInput);
  ...
  // abstractEvaluationParser.setPathsForAlteredOutputs(result, metaData,
  // alteredInput, alteredSolution);
  ...
  // MetaDataState mDS =
  // MetaDataState.getMDS(mDRElement.getAttribute("METADATASTATE"));

...
import model.mindmap.evaluation.MultipleRoots;
...
public class Test {
	...
	private static final String MINDMANAGER_TEMPLATE = "Results/MindManager/Vorlage.mmas";
	private static final String WORD_TEMPLATE = "Results/Word/Vorlage.dotx";
	
	public void abstractXToX(String readParser, String writeParser, String readPath, String writePath, String template) {
		try {
	...
	public void freePlanToFreePlane() {
		try {
			...
			LinkedList<TreeNode> listOfRoots = fpp.read(new File("C:/Users/Magnus/Dropbox/workspaceDropbox/java/Results/Freeplane/Eingabe.mm"));
			listOfRoots = Util.mergeTrees(listOfRoots);
			fpp.write("Results/Freeplane/F2F/Ausgabe.mm", listOfRoots, FREEPLANE_TEMPLATE);
	...
	public void freePlaneToMindManager() {
		try {
			...
			mmp.write("Results/Freeplane/F2M/Ausgabe.xml", listOfRoots, MINDMANAGER_TEMPLATE);
		} catch (ParserConfigurationException | SAXException | IOException e) {
			e.printStackTrace();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void latexToFreePlane() {
		try {
			LatexParser lp = new LatexParser();
			LinkedList<TreeNode> listOfRoots = lp.read(new File("C:/Users/Magnus/Dropbox/workspaceDropbox/java/Results/Latex/Eingabe.tex"));
			listOfRoots = Util.mergeTrees(listOfRoots);
			FreePlanParser fpp = new FreePlanParser();
	...
	public void latexToMindManager() {
		try {
			...
			listOfRoots = Util.mergeTrees(listOfRoots);
			MindManagerParser mmp = new MindManagerParser();
			mmp.write("Results/Latex/L2M/Ausgabe.xml", listOfRoots, MINDMANAGER_TEMPLATE);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void mindManagerToFreePlane() {
		try {
			MindManagerParser mmp = new MindManagerParser();
			LinkedList<TreeNode> listOfRoots = mmp.read(new File("C:/Users/Magnus/Dropbox/workspaceDropbox/java/Results/MindManager/Eingabe.xml"));
			listOfRoots = Util.mergeTrees(listOfRoots);
			FreePlanParser fpp = new FreePlanParser();
			fpp.write("Results/MindManager/M2F/Ausgabe.mm", listOfRoots, FREEPLANE_TEMPLATE);
		} catch (ParserConfigurationException | TransformerException e) {
			e.printStackTrace();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void mindManagerToLatex() {
		try {
			...
			listOfRoots = Util.mergeTrees(listOfRoots);
			LatexParser lp = new LatexParser();
			lp.write("Results/MindManager/M2L/Ausgabe.tex", listOfRoots, LATEX_TEMPLATE);
		} catch (IOException e) {
			e.printStackTrace();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void mindManagerToMindManager() {
		try {
			...
			LinkedList<TreeNode> listOfRoots = mmp.read(new File("C:/Users/Magnus/Dropbox/workspaceDropbox/java/Results/MindManager/Eingabe.xml"));
			listOfRoots = Util.mergeTrees(listOfRoots);
			mmp.write("Results/MindManager/M2M/Ausgabe.xml", listOfRoots, MINDMANAGER_TEMPLATE);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void mindManagerToWord() {
		try {
			...
			listOfRoots = Util.mergeTrees(listOfRoots);
			WordParser wp = new WordParser();
			wp.write("Results/MindManager/M2W/Ausgabe.docx", listOfRoots, WORD_TEMPLATE);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void wordToFreePlane() {
		try {
			WordParser wp = new WordParser();
			LinkedList<TreeNode> listOfRoots = wp.read(new File("C:/Users/Magnus/Dropbox/workspaceDropbox/java/Results/Word/Eingabe.docx"));
			listOfRoots = Util.mergeTrees(listOfRoots);
			FreePlanParser fpp = new FreePlanParser();
			fpp.write("Results/Word/W2F/Ausgabe.mm", listOfRoots, FREEPLANE_TEMPLATE);
		} catch (ParserConfigurationException | TransformerException | InvalidFormatException | IOException e) {
			e.printStackTrace();
		}
	}
	...
	public void wordToMindManager() {
		try {
			...
			listOfRoots = Util.mergeTrees(listOfRoots);
			MindManagerParser mmp = new MindManagerParser();
			mmp.write("Results/Word/W2M/Ausgabe.xml", listOfRoots, MINDMANAGER_TEMPLATE);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void evaluateMultipleRootMapsWithExcel(String parserType, String inputPathAttempt,

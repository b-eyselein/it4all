...
public class JsWebExercise {
  ...
  public String title = "Lass den Button verschwinden!";
  ...
  public String posterior = "  </script>\n</head>\n\n<body>\n"
      + "  <h3>Blenden Sie den folgenden Text aus, wenn der Button gedrückt wird, und wieder ein, wenn er nochmals gedrückt wird!</h3>\n"

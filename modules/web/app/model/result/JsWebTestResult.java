...
public class JsWebTestResult extends ElementResult {
  ...
  public JsWebTestResult(JsWebTask theTest, List<ConditionResult> thePreResults, boolean theActionPerf,
    ...
    super(theTest, analyze(thePostResults, theActionPerf, thePostResults), /* attributeResults */null,
  ...
  public String getAsHtml() {
    ...
    builder.append("<div class=\"panel-heading\"><h4 class=\"panel-title\"><a data-toggle=\"collapse\" href=\"#col"
        + task.key.taskId + "\">Test " + (task.key.taskId) + "</a></h4>" + DIV_END);
    
    builder.append("  <div id=\"col" + task.key.taskId + "\" class=\"panel-collapse collapse"

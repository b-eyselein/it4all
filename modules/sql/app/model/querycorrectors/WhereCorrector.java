...
public class WhereCorrector implements ExpressionVisitor {
  ...
  public WhereComparison correct(Expression userExpression, Expression sampleExpression) {
    sampleExpression.accept(this);
    userQueryAnalyzed = true;
    userExpression.accept(this);

    return (WhereComparison) binExMatcher.match(userExpressions, sampleExpressions);
  }

...
public class SqlQueryResult {
  ...
  private static final Matcher.StringEqualsMatcher STRING_EQ_MATCHER = new Matcher.StringEqualsMatcher();
  ...
  private static boolean checkColumnNames(List<String> firstColumnsNames, List<String> secondColumnNames) {
    return STRING_EQ_MATCHER.match("Spaltennamen", firstColumnsNames, secondColumnNames).isSuccessful();
  }
  ...
  private static String getColName(ResultSetMetaData metaData, int value) {
    try {
      ...
      Logger.debug("There has been an SQL error:", e);
      return "";
    }
  }

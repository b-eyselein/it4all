  ...
  private static void handleExercise(SqlScenario scenario, int exerciseId, String exerciseType, JsonNode exerciseNode) {
    ...
    if(exercise == null) {
      ...
      case "CREATE":
        ...
        break;
      case "DELETE":
        exercise = new DeleteExercise(exerciseKey);
        ((DeleteExercise) exercise).validation = exerciseNode.get("validation").asText();
        break;
      case "INSERT":
        exercise = new InsertExercise(exerciseKey);
        ((InsertExercise) exercise).validation = exerciseNode.get("validation").asText();
        break;
      default:

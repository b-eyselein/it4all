...
public class SqlController extends ExerciseController<SqlExercise, SqlResult> {
  ...
  protected List<SqlResult> correct(String learnerSolution, SqlExercise exercise, User user)
    ...
    QueryCorrector corrector = QueryCorrector$.MODULE$.getCorrector(exercise.exerciseType);
    Database db = getDBForExType(exercise.exerciseType);
    
    SqlResult result = corrector.correct(db, learnerSol, sample, exercise);

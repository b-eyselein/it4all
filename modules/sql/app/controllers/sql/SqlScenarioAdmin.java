...
public class SqlScenarioAdmin extends AExerciseCollectionAdminController<SqlExercise, SqlScenario> { // NOSONAR
  ...
  public Result scenarioAdmin(int id) {
    return ok(views.html.sqlAdmin.scenarioAdmin.render(getUser(), finder.byId(id)));
  }

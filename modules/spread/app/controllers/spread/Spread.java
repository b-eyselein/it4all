...
import model.SpreadExerciseIdentifier;
...
public class Spread extends ExerciseController<SpreadExerciseIdentifier> {
  ...
  @Override
  protected CompleteResult correct(Request request, User user, SpreadExerciseIdentifier exercise) {
    // FIXME: implement!
    return null;
  }

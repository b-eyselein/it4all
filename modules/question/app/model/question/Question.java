...
@Entity public class Question extends Exercise {
  ...
  @JsonProperty("exerciseType") public QType questionType;

  @OneToMany(mappedBy = "question", cascade = CascadeType.ALL) public List<Answer> answers;

  @OneToMany(mappedBy = "question", cascade = CascadeType.ALL) @JsonIgnore public List<UserAnswer> givenAnswers;

  @ManyToMany @JsonIgnore public List<Quiz> quizzes;
  ...
  @JsonIgnore public List<Answer> getCorrectAnswers() {
    return answers.parallelStream().filter(Answer::isCorrect).collect(Collectors.toList());
  }

  @JsonIgnore public boolean isFreetext() {

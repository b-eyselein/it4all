...
@Entity public class XmlExercise extends Exercise {

  public static final Finder<Integer, XmlExercise> finder = new Finder<>(XmlExercise.class);

  @Enumerated(EnumType.STRING) @JsonProperty(required = true) public XmlExType exerciseType;

  @Column @JsonProperty(required = true) public String rootNode;
  ...
  public String getFixedStart() {
    ...
    return String
        .format("<?xml version=\"1.0\" encoding=\"UTF-8\"?>%n<!DOCTYPE %s SYSTEM \"%s.dtd\">", rootNode, rootNode);
  }

  @JsonIgnore public String getGrammarFileEnding() {
    return exerciseType.getGramFileEnding();
  }

  @JsonIgnore public String getReferenceFileEnding() {
    return exerciseType.getRefFileEnding();
  }

  @JsonIgnore public String getStudentFileEnding() {
    return exerciseType.getStudFileEnding();
  }

  @Override @JsonIgnore public List<XmlExType> getTags() {
    return Arrays.asList(exerciseType);
  }

...
public class BlanksExercise extends Exercise {
  ...
  public BlanksExercise(int theId, String theTitle, String theAuthor, String theText) {
  ...
  @Override
  public void updateValues(int theId, String theTitle, String theAuthor, String theText, JsonNode other) {

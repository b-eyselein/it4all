...
class UmlAdmin @Inject() (f: FormFactory) extends AExerciseAdminController[UmlExercise](f, UmlToolObject, UmlExercise.finder, UmlExerciseReader) {

  override def adminIndex = Results.ok(views.html.umlAdmin.index.render(BaseController.getUser))

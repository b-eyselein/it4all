...
public class ProgController extends IdExController<ProgExercise, ProgEvaluationResult> {
    ...
    @Inject
    public ProgController(Configuration c, FormFactory f) {
        super(c, f, ProgExercise.finder, new ProgToolObject(c));
    }
    ...
    @Override
    public scala.util.Try<CompleteResult<ProgEvaluationResult>> correctEx(DynamicForm form,

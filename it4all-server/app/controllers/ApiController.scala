...
class ApiController @Inject()(
  ...
  def apiAllCollections(toolType: String): Action[AnyContent] =
  ...
  def apiExercises(toolType: String, collId: Int): Action[AnyContent] =
    JwtAuthenticatedToolMainAction(toolType).async { implicit request =>
  ...
  def reviewExercisePart(toolType: String, collId: Int, id: Int, partStr: String): EssentialAction =
    JwtAuthenticatedToolMainAction(toolType).async { request =>

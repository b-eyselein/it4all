...
val webJarDependencies = Seq(
  ...
  "org.webjars.npm" % "bootstrap" % "4.1.1",
  ...
  "org.webjars.npm" % "types__underscore" % "1.8.8",

  "org.webjars.npm" % "lodash" % "4.17.10", "org.webjars.npm" % "types__lodash" % "4.14.109",
  ...
  //  "org.webjars.npm" % "backbone" % "1.2.2" ,

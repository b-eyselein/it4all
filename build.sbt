...
libraryDependencies ++= Seq(
  ...
  // Mongo database
  "org.reactivemongo" %% "play2-reactivemongo"            % "1.0.0-play28-rc.3", // Apache 2.0
  "org.reactivemongo" %% "reactivemongo-play-json-compat" % "1.0.0-play29-rc.3", // Apache 2.0
  ...
  // GraphQL
  "org.sangria-graphql" %% "sangria"           % "2.0.1", // Apache 2.0

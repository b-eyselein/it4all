...
function createStartState(x: number, y: number): joint.shapes.uml.CustomStartState {
...
function createEndState(x: number, y: number): joint.shapes.uml.CustomEndstate {

...
function cellOnLeftClick(cellView, evt, x, y) {
    ...
    if (sel === 'POINTER') {
        ...
        if (chosenCellView === null) {
            ...
            let sourceMult = askMulitplicity(source, target);
            let targetMult = askMulitplicity(target, source);

            addAssociation(chosenCellView.model.id, cellView.model.id, sel, targetMult, sourceMult);

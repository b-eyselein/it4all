...
object TestHelperValues {
  ...
  val attrSpecs: Seq[AttributeSpecification] =
    Seq(RequiredSpecification, ImpliedSpecification, DefaultValueSpecification(DefaultValue), FixedValueSpecification(FixedValue))
